# RT
## RT is a rendering project of school 21(Ecole 42). It implements: lighting models: Phong, Path Tracing; Intersection methods: Raytracing, Raymarching algorithm. It uses GPU acceleration via OpenCL.   
